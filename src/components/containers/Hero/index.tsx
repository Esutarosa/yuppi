        ...
        <div className='mx-auto max-w-2xl text-center'>
          <div className='relative z-10 lg:h-auto pt-[90px] lg:pt-[90px] lg:min-h-[300px] flex flex-col items-center justify-center sm:mx-auto md:w-3/4 lg:mx-0 lg:w-full gap-4 lg:gap-8'>
            <div className='flex flex-col items-center'>
              ...
              <p className='text-muted-foreground my-3 pt-2 text-sm sm:mt-5 lg:mb-0 sm:text-base lg:text-lg'>Let's test your preparation and mental acuity with our quizzes on frontend and related programming languages.</p>
            </div>
