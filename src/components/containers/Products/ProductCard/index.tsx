  ...
  return (
    ...
    >
      <Panel
        ...
        innerClassName='relative overflow-hidden flex-1 flex flex-col items-center gap-5 lg:items-start justify-between bg-surface-100 w-full rounded-xl h-full'
      >
        <div className={cn(
          ...
          <div className='flex items-center justify-center h-12 w-12 bg-alternative rounded-lg mb-3'>{icon}</div>
